"""Initial migration for StudyGuru Pro (MySQL)
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "account_provider",
            sa.Enum("EMAIL", "GOOGLE", name="accountprovider"),
            nullable=True,
        ),
        sa.Column(
            "account_type",
            sa.Enum("SUPER_ADMIN", "ADMIN", "USER", name="useraccounttype"),
            nullable=False,
            server_default="USER",
        ),
        ...
        sa.Column("verify_status", sa.Boolean(), nullable=False, server_default="0"),
        sa.Column("current_points", sa.Integer(), nullable=False, server_default="30"),
        sa.Column(
            "total_points_earned", sa.Integer(), nullable=False, server_default="30"
        ),
        sa.Column(
            "total_points_used", sa.Integer(), nullable=False, server_default="0"
        ),
        sa.Column("purchased_subscription_id", sa.String(191), nullable=True),
        sa.Column("super_admin", sa.Boolean(), nullable=True, server_default="0"),
        ...
        sa.ForeignKeyConstraint(
            ["purchased_subscription_id"],
            ["purchased_subscription.id"],
        ),
        sa.PrimaryKeyConstraint("id"),
...
def downgrade() -> None:
    ...
    op.execute("DROP TYPE IF EXISTS accountprovider")
    op.execute("DROP TYPE IF EXISTS useraccounttype")
